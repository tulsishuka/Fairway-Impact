...
//           className="w-full bg-[#131815] border border-[#1C221E] rounded-[32px] px-6 py-16 md:py-20 text-center flex flex-col items-center justify-center shadow-2xl relative"
//         >
          
//           {/* Top Small Label */}
//           <span className="text-[10px] md:text-xs font-bold text-[#FFB3AE] tracking-[0.2em] uppercase mb-4">
//             Total Impact Jackpot
//           </span>

//           {/* Glowing Jackpot Amount */}
//           <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-sky-300 select-none drop-shadow-[0_0_35px_rgba(244,191,79,0.25)] mb-6">
//             $2,458,920
//           </h1>

//           {/* Description Body Text */}
//           <p className="text-gray-400 text-sm md:text-base font-normal max-w-xl mx-auto leading-relaxed mb-12 px-2">
//             Accumulated wealth ready for distribution to our global charity partners in the current cycle.
//           </p>

//           {/* Sub Stats Row Container */}
//           <div className="flex items-center justify-center gap-10 md:gap-14 w-full max-w-md border-t border-gray-800/40 pt-8">
...
//               </span>
//               <span className="text-xl md:text-2xl font-bold text-white tracking-wider font-mono">
//                 12:04:55
//               </span>
//             </div>
